...
export default function JobForm({ data:
    {
        emailPlaceholder, firstNamePlaceholder,
        phonePlaceholder, agreementText, submitText,
        emailErrorText, attachmentPlaceholder,
    ...
    const onSubmit = data => {
        ...
        axios.post('https://hook.eu1.make.com/h0nsbikhzf2idnvukdwcd7t4xdh9vqv3', formData, {
            headers: {
    ...
    return (
        <Wrapper id='job-form' onSubmit={handleSubmit(onSubmit)}>
            ...
            <label className="input">
                ...
                <input type='email' onSelect={(e) => { checkCount(e) }} className={errors.email ? 'error' : null} {...register("email", { required: true, pattern: /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/ })} placeholder={emailPlaceholder} />
                {errors.email && (
                    <motion.p
    ...
    label{
        ...
        &.attachment{
            ...
            .placeholder{
                ...
                display: flex;
                align-items: center;
                padding: clamp(12px, ${16 / 768 * 100}vw, 20px) clamp(24px, ${36 / 768 * 100}vw, 40px);
                ...
                .max{
                    ...
                    font-weight: 700;
                    font-size: clamp(13px, ${17 / 768 * 100}vw, 20px);
                    line-height: 140%;
                    text-align: right;
                    letter-spacing: 0.005em;
                    color: #F3F3F3;
