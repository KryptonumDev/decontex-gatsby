...
export default function Header({ location }) {
  ...
  const localeData = data.allWpPage.nodes.filter(
    (el) => el.language.slug === locale
  );
  const { link, navigation } = localeData[0].header;

  const [isDark, changeIsDark] = useState(
    whiteWersionPages.includes(location.pathname)
  );
  const [currentPage, changeCurrentPage] = useState(
    getCurrentPage(location, locale)
  );
  ...
  useEffect(() => {
    if (typeof window !== `undefined`) {
      ...
      document.addEventListener("click", (e) => {
        if (
          isLangChangerOpenedRef.current &&
          e.currentTarget.activeElement.id !== "lang-schoice"
        ) {
      ...
      <LocContainer>
        <Content>
          <Link aria-label="homepage" to={urls["Homepage"][locale]}>
            {isScrolled || isDark ? <LogoDark /> : <LogoWhite />}
          </Link>
          ...
          >
            <LangChoice
              ...
              isDark={isDark}
              isScrolled={isScrolled}
              isLangChangerOpened={isLangChangerOpened}
              data={data}
              locale={locale}
              changeIsLangChangerOpened={changeIsLangChangerOpened}
            />
            {navigation?.map((el, i) => (
              <div
                className={el.onlyInMobileMenu ? "item mobile" : "item"}
                key={i}
              >
                <NavLink
                  isDark={isDark}
                  isScrolled={isScrolled}
                  as={!el.linkUrl ? "div" : null}
                  to={el.linkUrl}
                  className={el?.dropdown?.length > 0 ? "div" : "a"}
                >
                  {el.linkName}
                  {el?.dropdown?.length > 0 && (
                    ...
                    >
                      <path
                        d="M19.7148 15.5L12.7148 9.5L5.71484 15.5"
                        stroke={isDark ? "#111315" : "#fff"}
                        strokeWidth="1.5"
                        strokeLinecap="round"
          ...
          {link.isouter === null ? (
            <ButtonOutlined className="cta" to={link.link}>
              {link.name}
            </ButtonOutlined>
          ) : (
            <ButtonOutlinedOuter className="cta" href={link.link}>
              {link.name}
            </ButtonOutlinedOuter>
          )}
...
const Navigation = styled.nav`
  ...
  @media (max-width: 1365px) {
    ...
    padding: clamp(40px, ${(52 / 768) * 100}vw, 53px)
      clamp(16px, ${(68 / 768) * 100}vw, 120px)
      clamp(40px, ${(50 / 768) * 100}vw, 60px)
      clamp(16px, ${(68 / 768) * 100}vw, 120px);
...
const Wrapper = styled.header`
  ...
  left: 0;
  padding: ${(props) =>
      props.isScrolled ? "12px" : "clamp(20px, 6.25vw, 48px)"}
    0;
  transition: background-color 0.3s cubic-bezier(0.39, 0.575, 0.565, 1),
    padding 0.3s cubic-bezier(0.39, 0.575, 0.565, 1),
    box-shadow 0.5s cubic-bezier(0.39, 0.575, 0.565, 1);
  background-color: ${(props) =>
    props.isScrolled ? "var(--color-white)" : "transparent"};
...
const LangChoice = ({
  ...
  data,
  locale,
  changeIsLangChangerOpened,
}) => {
  debugger
  if (currentPage) {
    return (
      <LanguageChoice
        className={desctop ? "desctop" : "mobile"}
        isDark={isDark}
        isScrolled={isScrolled}
        isLangChangerOpened={isLangChangerOpened}
      >
        {data.allWpPage.nodes.filter((el) => el !== "nb" && el !== "fi").map((el) => {
          if (el.language.slug === locale) {
            return (
              <li key={el.language.slug}>
                <button
                  id="lang-schoice"
                  tabIndex={desctop || isMenuOpened ? "0" : "-1"}
                  onClick={() => {
                    changeIsLangChangerOpened(!isLangChangerOpened);
                  }}
                >
                  {el.language.slug}
                  <svg
                  ...
                  >
                    <path
                      d="M12 14.575L0 2.57499L2.15 0.424988L12 10.325L21.85 0.474987L24 2.62499L12 14.575Z"
                      fill={isScrolled || isDark ? "#111315" : "#fff"}
                    />
                  </svg>
                </button>
              </li>
        ...
        <li>
          <ul>
            {data.allWpPage.nodes
              .filter((el) => el.language.slug !== "nb" && el.language.slug !== "fi")
              .map((el) => {
                if (el.language.slug !== locale) {
                  return (
                    <li key={el.language.slug}>
                      <Link
                        tabIndex={isLangChangerOpened ? "0" : "-1"}
                        to={currentPage[el.language.slug]}
                        onClick={() => {
                          changeIsMenuOpened(false);
                        }}
                      >
...
const LogoDark = () => (
  ...
  >
    ...
    />
    <path
      d="M150.218 39.0664V43.453H144.048V39.0664H143.004V48.9075H144.048V44.3665H150.218V48.9075H151.247V39.0664H150.218Z"
      fill="#111315"
    />
    <path
      d="M155.968 48.0089V44.3532H161.07V43.4662H155.968V39.965H161.689V39.0664H154.926V48.9075H161.9V48.0089H155.968Z"
      fill="#111315"
    />
    <path
      d="M173.002 48.9108H174.101L169.599 39.0664H168.572L164.055 48.9108H165.138L166.319 46.2816H171.823L173.002 48.9108ZM166.696 45.4395L169.07 40.1444L171.445 45.4395H166.696Z"
      fill="#111315"
    />
    <path
      d="M177.552 48.0089V39.0664H176.508V48.9075H183.075V48.0089H177.552Z"
      fill="#111315"
    />
    <path
      d="M183.016 39.0664V39.965H186.483V48.9075H187.525V39.965H190.992V39.0664H183.016Z"
      fill="#111315"
    />
    <path
      d="M200.683 39.0664V43.453H194.511V39.0664H193.469V48.9075H194.511V44.3665H200.683V48.9075H201.712V39.0664H200.683Z"
      fill="#111315"
    />
    <path
      d="M206.429 39.0664H205.387V48.9092H206.429V39.0664Z"
      fill="#111315"
    />
    <path
      d="M211.151 48.0089V44.3532H216.252V43.4662H211.151V39.965H216.873V39.0664H210.109V48.9075H217.084V48.0089H211.151Z"
      fill="#111315"
    />
    <path
      d="M227.728 48.9102L225.316 45.5335C225.447 45.4924 225.574 45.4442 225.699 45.389C226.266 45.1507 226.75 44.7495 227.088 44.2363C227.422 43.6987 227.591 43.075 227.574 42.4425C227.594 41.7992 227.425 41.1639 227.088 40.6155C226.75 40.1023 226.266 39.7011 225.699 39.4628C225.014 39.1788 224.277 39.0424 223.535 39.0625H219.852V48.9102H220.895V45.7893H223.544C223.809 45.7892 224.074 45.7742 224.338 45.7445L226.588 48.9102H227.728ZM223.515 44.904H220.895V39.9694H223.515C224.502 39.9694 225.251 40.1847 225.763 40.6155C226.274 41.0462 226.53 41.6552 226.532 42.4425C226.532 43.2176 226.275 43.8222 225.763 44.2563C225.25 44.6903 224.501 44.9051 223.515 44.9007V44.904Z"
      fill="#111315"
    />
    <path
      d="M230.256 48.9785C230.157 48.9801 230.058 48.9608 229.967 48.9218C229.876 48.8829 229.794 48.8253 229.726 48.7526C229.655 48.6804 229.599 48.5947 229.562 48.5005C229.524 48.4064 229.506 48.3057 229.508 48.2045C229.505 48.105 229.521 48.0057 229.557 47.9129C229.594 47.82 229.648 47.7355 229.718 47.6644C229.788 47.5934 229.872 47.5373 229.964 47.4997C230.057 47.462 230.156 47.4436 230.256 47.4454C230.355 47.4438 230.454 47.4624 230.547 47.5002C230.639 47.5379 230.722 47.594 230.792 47.665C230.862 47.7361 230.916 47.8205 230.952 47.9133C230.988 48.006 231.005 48.1051 231.001 48.2045C231.004 48.3058 230.986 48.4066 230.948 48.5007C230.911 48.5949 230.855 48.6806 230.783 48.7526C230.716 48.8252 230.635 48.8829 230.544 48.9218C230.453 48.9607 230.355 48.98 230.256 48.9785Z"
      fill="#111315"
    />
  </svg>
);
...
const LogoWhite = () => (
  ...
  >
    ...
    />
    <path
      d="M227.934 29.4325L217.114 14.4674L227.228 0.492188H219.979L213.411 9.8267L206.762 0.492188H199.18L209.317 14.6966L198.641 29.4325H206.306L213.194 19.3738L220.186 29.4325H227.934Z"
      fill="#F3F3F3"
    />
    <path
      d="M6.92813 47.7832C6.42421 47.9741 5.8891 48.0699 5.3501 48.0656C4.78651 48.0704 4.22719 47.9678 3.70215 47.7633C3.2047 47.5697 2.75169 47.2776 2.37047 46.9046C1.99477 46.5351 1.69557 46.0955 1.4899 45.6107C1.06812 44.5693 1.06812 43.405 1.4899 42.3636C1.69599 41.8791 1.99514 41.4395 2.37047 41.0697C2.75132 40.6966 3.20446 40.405 3.70215 40.2127C4.22696 40.0074 4.78644 39.9048 5.3501 39.9104C5.88839 39.9058 6.42305 39.9986 6.92813 40.1844C7.43542 40.3792 7.89309 40.6838 8.26813 41.0763L8.93397 40.412C8.49661 39.9319 7.95036 39.5634 7.34095 39.3373C6.02551 38.8544 4.57994 38.8591 3.26769 39.3506C2.65655 39.5883 2.0987 39.9445 1.6264 40.3987C1.16121 40.8503 0.792075 41.3909 0.541077 41.9882C0.0279743 43.2676 0.0279743 44.695 0.541077 45.9745C0.791425 46.5739 1.16092 47.1166 1.62726 47.5696C2.0936 48.0227 2.64711 48.3767 3.25437 48.6104C4.57189 49.1027 6.02344 49.1027 7.34095 48.6104C7.95025 48.3801 8.49618 48.009 8.93397 47.5275L8.26813 46.8631C7.89453 47.2642 7.43704 47.5783 6.92813 47.7832Z"
    ...
    />
    <path
      d="M12.6202 48.0089V39.0664H11.5781V48.9075H18.1433V48.0089H12.6202Z"
      fill="#F3F3F3"
    />
    <path
      d="M21.6921 48.0089V44.3532H26.7925V43.4662H21.6921V39.965H27.4134V39.0664H20.6484V48.9075H27.6248V48.0089H21.6921Z"
    ...
    />
    <path
      d="M49.4487 39.0664V47.0489L43.0933 39.0664H42.2344V48.9075H43.2764V40.9267L49.6185 48.9075H50.4774V39.0664H49.4487Z"
      fill="#F3F3F3"
    />
    <path
      d="M55.0264 48.0089V44.3532H60.1284V43.4662H55.0264V39.965H60.7476V39.0664H53.9844V48.9075H60.959V48.0089H55.0264Z"
    ...
    />
    <path
      d="M114.575 48.0089V44.3532H119.675V43.4662H114.575V39.965H120.294V39.0664H113.531V48.9075H120.506V48.0089H114.575Z"
      fill="#F3F3F3"
    />
    <path
      d="M131.158 48.911L128.746 45.5343C128.876 45.4926 129.004 45.4444 129.129 45.3898C129.696 45.1511 130.179 44.7499 130.517 44.2371C130.851 43.6992 131.02 43.0757 131.003 42.4433C131.023 41.8 130.854 41.1649 130.517 40.6163C130.179 40.1034 129.696 39.7023 129.129 39.4635C128.447 39.1807 127.712 39.0444 126.973 39.0633H123.281V48.911H124.325V45.7901H126.975C127.24 45.7899 127.505 45.7749 127.769 45.7452L130.018 48.911H131.158ZM126.945 44.9048H124.325V39.9701H126.947C127.932 39.9701 128.681 40.1855 129.194 40.6163C129.707 41.047 129.962 41.656 129.961 42.4433C129.961 43.2184 129.705 43.823 129.194 44.257C128.682 44.6911 127.933 44.9059 126.945 44.9015V44.9048Z"
      fill="#F3F3F3"
    />
    <path
      d="M133.677 48.9785C133.578 48.98 133.48 48.9607 133.389 48.9218C133.298 48.8828 133.217 48.8252 133.15 48.7526C133.078 48.6807 133.022 48.595 132.984 48.5009C132.946 48.4067 132.928 48.3059 132.93 48.2045C132.93 48.0062 133.009 47.8161 133.149 47.6759C133.29 47.5358 133.48 47.457 133.679 47.457C133.878 47.457 134.068 47.5358 134.209 47.6759C134.349 47.8161 134.428 48.0062 134.428 48.2045C134.43 48.3057 134.412 48.4064 134.374 48.5005C134.337 48.5946 134.281 48.6804 134.21 48.7526C134.142 48.8255 134.06 48.8833 133.968 48.9222C133.876 48.9611 133.777 48.9803 133.677 48.9785Z"
    ...
    />
    <path
      d="M150.222 39.0664V43.453H144.052V39.0664H143.008V48.9075H144.052V44.3665H150.222V48.9075H151.251V39.0664H150.222Z"
      fill="#F3F3F3"
    />
    <path
      d="M155.972 48.0089V44.3532H161.074V43.4662H155.972V39.965H161.693V39.0664H154.93V48.9075H161.904V48.0089H155.972Z"
      fill="#F3F3F3"
    />
    <path
      d="M173.002 48.9108H174.101L169.599 39.0664H168.572L164.055 48.9108H165.138L166.319 46.2816H171.823L173.002 48.9108ZM166.696 45.4395L169.07 40.1444L171.445 45.4395H166.696Z"
    ...
    />
    <path
      d="M206.425 39.0664H205.383V48.9092H206.425V39.0664Z"
      fill="#F3F3F3"
    />
    <path
      d="M211.151 48.0089V44.3532H216.252V43.4662H211.151V39.965H216.873V39.0664H210.109V48.9075H217.084V48.0089H211.151Z"
