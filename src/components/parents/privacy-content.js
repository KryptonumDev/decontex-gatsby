...
export default function PrivacyContent({ data: { columns, contactPrivacy } }) {
    return (
        <Wrapper>
            <Container>
                ...
                <Contact>
                    ...
                    <a href={'mailto:' + contactPrivacy.contactMail}>{contactPrivacy.contactMail}</a>
                </Contact>
            </Container>
        </Wrapper>
    )
...
const Wrapper = styled.div`
    ...
    padding-bottom: clamp(75px, ${120 / 768 * 100}vw, 192px);
    max-width: 1920px;
    margin: 0 auto;
`
